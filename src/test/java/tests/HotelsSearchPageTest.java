...
public class HotelsSearchPageTest extends BaseTest {
	...
	public void loading() throws IOException {
		properties = PropertiesManager.loadProperties("hotelsSearchPage.properties");
		hotelsSearchPage = new HotelsSearchPage(driver);
	}

	@Test(priority = 1)
	public void validateTitle() {
		String expTitle = PropertiesManager.getProperty(properties, "expected.destination")
				+ PropertiesManager.getProperty(properties, "expected.title");
